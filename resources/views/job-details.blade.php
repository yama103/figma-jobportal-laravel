                ...
                <article class="job-card">
                  ...
                  <div class="job-card__main">
                    ...
                    <div class="job-card__contents">
                      ...
                      <p class="job-card__subtitle">Leffler and Sons</p>
                    </div>
                  </div>
              ...
              <section class="job-message">
                ...
                <form class="job-message__form">
                  <div class="job-message__field">
                    <img
                      class="job-message__icon"
                      src="images/name.svg"
                      alt=""
                    />

                    <input
                      class="job-message__input"
                      type="text"
