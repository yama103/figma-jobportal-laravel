                        ...
                        <div class="jobs__item">
                            <article class="job-card">
                                ...
                                <div class="job-card__main">
                                    <img src="{{ asset('images/jobs-4.svg') }}" alt="" />
                                ...
                                <div class="job-card__bottom">
                                    <ul class="job-card__meta">
                                        ...
                                        <li class="job-card__meta-item">
                                            <img src="{{ asset('images/clock-job-card.svg') }}" alt="" />
                                            <span>{{ $job->type }}</span>
                                        </li>
                                ...
                                <ul class="job-details__list">
                                    @foreach ($job->responsibilities as $responsibility)
                                        <li class="job-details__item">
                                            <img src="{{ asset('images/check.svg') }}" alt="" aria-hidden="true" />
                                    ...
                                    @foreach ($relatedJobs as $relatedJob)
                                        <li class="jobs__item">
                                            <article class="job-card">
                                                ...
                                                <div class="job-card__main">
                                                    <img src="{{ asset('images/jobs-7.svg') }}" alt="" />
                                                ...
                                                <div class="job-card__bottom">
                                                    <ul class="job-card__meta">
                                                        ...
                                                        <li class="job-card__meta-item">
                                                            <img src="{{ asset('images/clock-job-card.svg') }}"
                                                                alt="" />
                        ...
                        <section class="job-overview">
                            ...
                            <ul class="job-overview__list">
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/person.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/clock-job-card.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/bag.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/experience.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/degree.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/wallet.svg') }}"
                                        alt="" />
                                ...
                                <li class="job-overview__item">
                                    <img class="job-overview__icon" src="{{ asset('images/location.svg') }}"
                                        alt="" />
                        ...
                        <section class="job-message">
                            ...
                            <form class="job-message__form">
                                <div class="job-message__field">
                                    <img class="job-message__icon" src="{{ asset('images/name.svg') }}"
                                        alt="" />
                                ...
                                <div class="job-message__field">
                                    <img class="job-message__icon" src="{{ asset('images/email-details.svg') }}"
                                        alt="" />
                                ...
                                <div class="job-message__field">
                                    <img class="job-message__icon" src="{{ asset('images/phone-details.svg') }}"
                                        alt="" />
                                ...
                                <div class="job-message__field job-message__field--textarea">
                                    <img class="job-message__icon" src="{{ asset('images/message.svg') }}"
                                        alt="" />
