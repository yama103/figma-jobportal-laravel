            ...
            <ul class="hero__statistics">
              <li class="hero__stat">
                ...
                <div class="hero__stat-content">
                  <span class="hero__stat-number">25,850</span
              ...
              <li class="hero__stat">
                ...
                <div class="hero__stat-content">
                  <span class="hero__stat-number">10,250</span
                  ><span class="hero__stat-label">Candidates</span>
                </div>
              </li>
              <li class="hero__stat">
                <img src="images/companies.svg" alt="" />
                <div class="hero__stat-content">
                  <span class="hero__stat-number">18,400</span
        ...
        <div class="container">
          <div class="jobs__wrapper">
            <div class="jobs__header">
              ...
              <a class="viewall-link viewall-link--desktop" href="jobs.html"
                >View all</a
              >
            </div>
              ...
              <li class="jobs__item">
                <article class="job-card">
                  ...
                  <div class="job-card__main">
                    ...
                    <div class="job-card__contents">
                      <p class="job-card__title">District Intranet Director</p>
            ...
            <a class="viewall-link viewall-link--mobile" href="jobs.html"
              >View all</a
            >
          </div>
        </div>
              ...
              <li class="category__item">
                <a class="category__link" href="#">
                  <img
                    ...
                    alt=""
                  />
                  <p class="category__title">Agriculture</p>
                  <p class="badge">1254 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
                  <img class="category__icon" src="images/metal.svg" alt="" />
                  <p class="category__title">Metal Production</p>
                  <p class="badge">816 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
                  <img
                    ...
                    alt=""
                  />
                  <p class="category__title">Commerce</p>
                  <p class="badge">2082 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
                  <img
                    ...
                    alt=""
                  />
                  <p class="category__title">Construction</p>
                  <p class="badge">1520 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
                  <img class="category__icon" src="images/hotels.svg" alt="" />
                  <p class="category__title">Hotels & Tourism</p>
                  <p class="badge">1022 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
              ...
              <li class="category__item">
                <a class="category__link" href="#">
                  <img
                    ...
                    alt=""
                  />
                  <p class="category__title">Financial Services</p>
                  <p class="badge">1529 jobs</p>
                </a>
              </li>
              <li class="category__item">
                <a class="category__link" href="#">
                  <img
                    ...
                    alt=""
                  />
                  <p class="category__title">Transport</p>
                  <p class="badge">1244 jobs</p>
                </a>
              </li>
            </ul>
          </div>
